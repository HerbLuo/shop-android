...
public abstract class CheckPermissionsActivity extends AppCompatActivity
	...
	private static final int PERMISSON_REQUESTCODE = 3;
	...
	public void onRequestPermissionsResult(int requestCode,
        ...
        System.out.println(Arrays.toString(paramArrayOfInt));
        if (requestCode == PERMISSON_REQUESTCODE) {
			if (!verifyPermissions(paramArrayOfInt)) {
				showMissingPermissionDialog();
				isNeedCheck = false;
			} else {
                onAllPermissionsGetted();
            }
		}
	}
     ...
     * 最主要是定位权限
     */
	protected abstract void onAllPermissionsGetted();
